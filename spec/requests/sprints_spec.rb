  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Sprint" do
        expect {
          post sprints_url, params: { sprint: valid_attributes }
        }.to change(Sprint, :count).by(1)
      end

      it "redirects to the created sprint" do
        post sprints_url, params: { sprint: valid_attributes }
        expect(response).to redirect_to(sprint_url(Sprint.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Sprint" do
        expect {
          post sprints_url, params: { sprint: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested sprint" do
        sprint = Sprint.create! valid_attributes
        patch sprint_url(sprint), params: { sprint: new_attributes }
        sprint.reload
      ...
      it "redirects to the sprint" do
        ...
        patch sprint_url(sprint), params: { sprint: new_attributes }
        sprint.reload
        expect(response).to redirect_to(sprint_url(sprint))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        sprint = Sprint.create! valid_attributes
        patch sprint_url(sprint), params: { sprint: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
